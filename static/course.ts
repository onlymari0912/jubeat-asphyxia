export const COURSE_TYPE_PERMANENT = 1
export const COURSE_TYPE_TIME_BASED = 2

export const COURSE_CLEAR_SCORE = 1
export const COURSE_CLEAR_COMBINED_SCORE = 2
export const COURSE_CLEAR_HAZARD = 3

export const COURSE_HAZARD_NONE = 0
export const COURSE_HAZARD_EXC1 = 1
export const COURSE_HAZARD_EXC2 = 2
export const COURSE_HAZARD_EXC3 = 3
export const COURSE_HAZARD_FC1 = 4
export const COURSE_HAZARD_FC2 = 5
export const COURSE_HAZARD_FC3 = 6
